...
if (isset($_SESSION['id'])&&isset($_SESSION['username'])&&isset($_SESSION['password'])&&isset($_SESSION['first_name'])&&isset($_SESSION['last_name'])&&isset($_POST['patient_id'])&&isset($_POST['drug_id'])&&isset($_POST['start_date'])) {
	...
	$q="INSERT INTO _is_on_drug (patient_id, drug_id, start_date) VALUES ('".$mysqli->real_escape_string($_POST['patient_id'])."', '".$mysqli->real_escape_string($_POST['drug_id'])."', '".$mysqli->real_escape_string($_POST['start_date'])."')";
	...
	$qq="SELECT * FROM _is_on_drug WHERE patient_id='".$mysqli->real_escape_string($_POST['patient_id'])."' AND drug_id='".$mysqli->real_escape_string($_POST['drug_id'])."'";
